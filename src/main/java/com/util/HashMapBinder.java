...
/*
 * 텍스트 파일 처리(문자열 처리) - 숫자도 문자열로 처리히야함 - 숫자도 문자열로 처리한 후 변경해서 출력
...
public class HashMapBinder {
	   ...
	   //첨부파일의 한글 처리 // 나는 바보입니다 .
	   String encType = "utf-8";
	   //첨부파일의 최대 크기
	   int maxSize = 5*1024*1024; //5MB
	   public HashMapBinder(HttpServletRequest req) {
	      this.req = req;
	      realFolder = "C:\\git_20220415\\dev-web\\src\\main\\webapp\\pbs";
	   }
	...
	public void bind(Map<String,Object> pMap) {
		...
		pMap.clear();// 초기화를 해준다. (기존에 들어있던 정보 비우기)
