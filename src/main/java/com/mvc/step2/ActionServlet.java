...
public class ActionServlet extends HttpServlet {
	...
	public void doService(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		// 요청 URL을 통해서 해당하는 업무의 클래스 객체를 주입받고
		...
		Object obj = null;
		obj = board2Controller.execute(req, res);
		// page로 넘어오는 값의 유형
		// redirect:board2/boardInsert.jsp -> :이 있는 경우
		...
		if (obj != null) {
			...
			if (obj instanceof String) {
				if (((String) obj).contains(":")) {
					...
					// pageMove[0] = redirect of forward - redirect유무담기
			...
			// 업무에 대한 처리와 처이 결과에 대한 응답 페이지에 대한 정보는 각 컨트롤 클래스에 갖지만
			...
			if(pageMove != null) {
	            ...
	            // localhost:8000/board2/boardList -> boardList.jsp 출력
