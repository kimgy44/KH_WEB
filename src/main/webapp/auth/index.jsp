...
<head>
   ...
   <script type="text/javascript">
      ...
      // 순서지향적인, 절차지향적인 코딩 -> 모듈화 -> 비동기처럼 처기 하기(연습-await, async)
      function memberList(){
          alert("회원목록 호출 성공");
          // before
          // 아래 코드는 클라이언트 측에 같이 다운로드가 완료된 상태에서 처리가 된다. -> 결정이 되었다..
          // 시점
          // jeasyUI datagrid에서도 get방식과 post방식 지원한다. -> 차이점?
...
<!-- ######################## 메뉴 영역 시작  ##################### -->
  <div style="margin:20px 0;"></div>
        <ul id="tre_gym" class="easyui-tree" style="margint:0 6px;">
            <li data-options="state:'closed'">
        		<span>회원관리</span>
                      ...
                      <li>
                         <a href="javascript:member()">회원삭제</a>
                      </li>
              </li>
              <li data-options="state:'closed'">
                  <span>쪽지관리</span>
